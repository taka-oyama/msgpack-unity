...
namespace SouthPointe.Serialization.MessagePack.Tests
{
	public class FloatHandlerTest : TestBase
	{
		...
		{
			float value = 0.0f;
			byte[] data = Pack<float>(value);
			float result = Unpack<float>(data);
		...
		{
			float value = Unpack<float>(ReadFile("Floats/Float64Zero"));
		...
		public void UnpackFloat64MinAsFloat()
		{
			Assert.Throws<InvalidCastException>(() => {
				Unpack<float>(ReadFile("Floats/Float64Min"));
			});
		}
		...
		{
			Assert.Throws<InvalidCastException>(() => {
				Unpack<float>(ReadFile("Floats/Float64Max"));
			});
		}
		...
		{
			float value = Unpack<float>(ReadFile("Ints/PositiveFixIntMin"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/PositiveFixIntMax"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt8Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt8Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt16Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt16Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt32Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt32Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt64Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/UInt64Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/NegativeFixIntMin"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/NegativeFixIntMax"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int8Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int8Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int16Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int16Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int32Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int32Max"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int64Min"));
		...
		{
			float value = Unpack<float>(ReadFile("Ints/Int64Max"));
