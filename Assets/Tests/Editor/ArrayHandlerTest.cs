...
namespace SouthPointe.Serialization.MessagePack.Tests
{
	public class ArrayHandlerTest : TestBase
	{
		...
		{
			int?[] nil = Unpack<int?[]>(ReadFile("Arrays/Nil"));
		...
		{
			int?[] nils = Unpack<int?[]>(ReadFile("Arrays/Nils"));
		...
		{
			int[][] arrays = Unpack<int[][]>(ReadFile("Arrays/Arrays"));
		...
		{
			Map[] maps = Unpack<Map[]>(ReadFile("Arrays/Maps"));
		...
		{
			int[] test = Unpack<int[]>(ReadFile("Arrays/FixArrayMin"));
		...
		{
			int[] ints = Unpack<int[]>(ReadFile("Arrays/FixArrayMax"));
		...
		{
			int[] ints = Unpack<int[]>(ReadFile("Arrays/Array16Min"));
		...
		{
			int[] ints = Unpack<int[]>(ReadFile("Arrays/Array16Max"));
		...
		{
			int[] ints = Unpack<int[]>(ReadFile("Arrays/Array32Min"));
