...
namespace MessagePack.Tests
{
	public class DoubleHandlerTest : TestBase
	{
		...
		{
			double value = 0.0;
			byte[] data = MessagePack.Pack<double>(value);
			double result = MessagePack.Unpack<double>(data);
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Floats/Float64Zero"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Floats/Float64Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Floats/Float64Max"));
		...
		{
			float value = MessagePack.Unpack<float>(ReadFile("Floats/Float32Zero"));
		...
		{
			float value = MessagePack.Unpack<float>(ReadFile("Floats/Float32Min"));
		...
		{
			float value = MessagePack.Unpack<float>(ReadFile("Floats/Float32Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/PositiveFixIntMin"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/PositiveFixIntMax"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt8Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt8Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt16Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt16Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt32Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt32Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt64Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/UInt64Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/NegativeFixIntMin"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/NegativeFixIntMax"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int8Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int8Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int16Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int16Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int32Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int32Max"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int64Min"));
		...
		{
			double value = MessagePack.Unpack<double>(ReadFile("Ints/Int64Max"));
