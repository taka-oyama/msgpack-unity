...
namespace MessagePack.Tests
{
	public class ObjectHandlerTest : TestBase
	{
		...
		{
			object value = null;
			byte[] data = MessagePack.Pack<object>(value);
			object result = MessagePack.Unpack<object>(data);
		...
		public void PackNils()
		{
			...
			byte[] data = MessagePack.Pack<object>(value);
			List<object> result = (List<object>)MessagePack.Unpack<object>(data);
		...
		public void PackStruct()
		{
			...
			byte[] data = MessagePack.Pack<object>(value);
			Dictionary<object, object> result = (Dictionary<object, object>)MessagePack.Unpack<object>(data);
			Assert.AreEqual(2, result.Count);
		...
		{
			Assert.AreEqual(null, MessagePack.Unpack<object>(ReadFile("Arrays/Nil")));
		}

		[Test]
		public void UnpackFalse()
		{
			Assert.AreEqual(false, MessagePack.Unpack<object>(ReadFile("Bools/False")));
		}

		[Test]
		public void UnpackTrue()
		{
			Assert.AreEqual(true, MessagePack.Unpack<object>(ReadFile("Bools/True")));
		}

		[Test]
		public void UnpackPositiveFixInt()
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/PositiveFixIntMax"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/UInt8Max"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/UInt16Max"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/UInt32Max"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/UInt64Max"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/NegativeFixIntMin"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/Int8Min"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/Int16Min"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/Int32Min"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Ints/Int64Min"));
		...
		{
			object value = MessagePack.Unpack<object>(ReadFile("Floats/Float64Zero"));
		...
		{
			Assert.AreEqual("", MessagePack.Unpack<object>(ReadFile("Strings/FixStrMin")));
		}

		[Test]
		public void UnpackStr8Min()
		{
			Assert.AreEqual(new String('A', 32), MessagePack.Unpack<object>(ReadFile("Strings/Str8Min")));
		}

		[Test]
		public void UnpackStr16Min()
		{
			Assert.AreEqual(new String('A', byte.MaxValue + 1), MessagePack.Unpack<object>(ReadFile("Strings/Str16Min")));
		}

		[Test]
		public void UnpackStr32Min()
		{
			Assert.AreEqual(new String('A', ushort.MaxValue + 1), MessagePack.Unpack<object>(ReadFile("Strings/Str32Min")));
		}

		[Test]
		public void UnpackNils()
		{
			object[] nils = MessagePack.Unpack<object[]>(ReadFile("Arrays/Nils"));
		...
		{
			object map = MessagePack.Unpack<object>(ReadFile("Maps/Struct"));
