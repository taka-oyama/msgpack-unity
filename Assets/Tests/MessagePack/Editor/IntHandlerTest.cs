...
namespace MessagePack.Tests
{
	public class IntHandlerTest : TestBase
	{
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/PositiveFixIntMin"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/PositiveFixIntMax"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/UInt8Min"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/UInt8Max"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/UInt16Min"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/UInt16Max"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/UInt32Min"));
		...
		{
			Assert.Throws<OverflowException>(() => MessagePack.Unpack<int>(ReadFile("Ints/UInt32Max")));
		}

		[Test]
		public void UnpackUInt64MinAsInt()
		{
			Assert.Throws<FormatException>(() => MessagePack.Unpack<int>(ReadFile("Ints/UInt64Min")));
		}

		[Test]
		public void UnpackUInt64MaxAsInt()
		{
			Assert.Throws<FormatException>(() => MessagePack.Unpack<int>(ReadFile("Ints/UInt64Max")));
		}

		[Test]
		public void UnpackNegativeFixIntMinAsInt()
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/NegativeFixIntMin"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/NegativeFixIntMax"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int8Min"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int8Max"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int16Min"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int16Max"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int32Min"));
		...
		{
			int value = MessagePack.Unpack<int>(ReadFile("Ints/Int32Max"));
		...
		{
			Assert.Throws<FormatException>(() => MessagePack.Unpack<int>(ReadFile("Ints/Int64Min")));
		}

		[Test]
		public void UnpackInt64MaxAsInt()
		{
			Assert.Throws<FormatException>(() => MessagePack.Unpack<int>(ReadFile("Ints/Int64Max")));
		}
